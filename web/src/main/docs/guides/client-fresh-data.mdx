...
<QueryPatternsSvg patternOption="CLIENT" index={1} />
...
3. **Browser**: Receives the response, hydrates the page and sends a request to the API for the data.
4. **Browser**: Receives the fresh data and displays the data.
